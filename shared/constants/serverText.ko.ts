...
export const SERVER_ERROR_MESSAGES = {
  ...
  galleryDisabled: "갤러리 폴더가 설정되지 않았습니다.",
  invalidGalleryPath: "갤러리 경로가 올바르지 않습니다.",
  galleryEntryNotFound: "갤러리 항목을 찾을 수 없습니다.",
  unsupportedGalleryMedia: "지원하지 않는 미디어 형식입니다.",
...
export const SERVER_CONFIG_ERROR_MESSAGES = {
  ...
  invalidGalleryRoot: `${SERVER_ENVIRONMENT_KEYS.galleryRoot}는 존재하는 절대 폴더 경로여야 합니다.`,
} as const;
